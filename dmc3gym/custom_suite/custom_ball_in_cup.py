...
def get_model_and_assets(ball_size):
  """Returns a tuple containing the model XML string and a dict of assets."""
  xml_string = common.read_model('ball_in_cup.xml')
  mjcf = etree.fromstring(xml_string)
  cup = mjcf.find('./worldbody/body')
  ball = cup.getnext()
  ball = ball.getchildren()[2] 
  ball.set('size', "%g"%ball_size)
