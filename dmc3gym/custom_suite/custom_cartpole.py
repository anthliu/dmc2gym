...
"""Cartpole domain, copied from dm_control."""
...
def get_model_and_assets(pole_length=1, num_poles=1):
  """Returns a tuple containing the model XML string and a dict of assets."""
  return _make_model(pole_length, num_poles), common.ASSETS
...
def _make_model(pole_length, n_poles):
  ...
  #     suite_dir, 'custom_suite/custom_cartpole.xml'))
  mjcf = etree.fromstring(xml_string)
  pole = mjcf.find('./default/default/')
  pole = pole.getnext()
  pole.set('fromto', '0 0 0 0 0 %g'%pole_length)
